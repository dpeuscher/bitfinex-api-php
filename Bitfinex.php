...
class Bitfinex
{
     ...
     * @return mixed
     */
    public function get_book($symbol = 'BTCUSD', $data = [])
    {
     ...
     * @return mixed
     */
    public function get_lendbook($currency = 'USD', $data = [])
    {
     ...
     * @return mixed
     */
    public function get_lends($currency = 'USD', $data = [])
    {
     ...
     * @return mixed
     */
    public function get_trades($symbol = 'BTCUSD', $data = [])
    {
    ...
    public function new_order(
        ...
        if ($ocoorder) {
            ...
            $data['sell_price_oco'] = $sell_price_oco;
        }
     ...
     * @return mixed
     */
    public function get_history_movements(
        $currency = 'USD',
        $method = 'bitcoin',
        $limit = 500,
        $since = null,
     ...
     * @return mixed
     */
    public function withdraw($withdraw_type, $walletselected, $amount, $address = '', $expressWire = 0, $bank_data = [])
    {
        ...
        switch ($withdraw_type) {
            ...
            case 'wire':
                ...
                $data['detail_payment'] = array_key_exists('detail_payment',
                    $bank_data) ? $bank_data['detail_payment'] : '';

                $data['intermediary_bank_name'] = array_key_exists('im_bank_name',
                    $bank_data) ? $bank_data['im_bank_name'] : '';
                $data['intermediary_bank_address'] = array_key_exists('im_bank_address',
                    $bank_data) ? $bank_data['im_bank_address'] : '';
                $data['intermediary_bank_city'] = array_key_exists('im_bank_city',
                    $bank_data) ? $bank_data['im_bank_city'] : '';
                $data['intermediary_bank_country'] = array_key_exists('im_bank_country',
                    $bank_data) ? $bank_data['im_bank_country'] : '';
                $data['intermediary_bank_account'] = array_key_exists('im_bank_account',
                    $bank_data) ? $bank_data['im_bank_account'] : '';
                $data['intermediary_bank_swift'] = array_key_exists('im_bank_swift',
                    $bank_data) ? $bank_data['im_bank_swift'] : '';
